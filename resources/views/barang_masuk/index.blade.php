...
<div class="container">
    ...
    <div class="mb-3">
        ...
        <div class="d-flex align-items-center">
            ...
            {{-- KANAN (DIPAKSA KE UJUNG) --}}
            <div class="d-flex align-items-center ml-auto">
                <span class="font-weight-bold mr-2">Status:</span>

                <form method="GET" action="{{ route('barang-masuk.index') }}" class="mb-0">
                    <select name="status"
            ...
            <form method="POST" action="{{ route('barang-masuk.store') }}">
                ...
                <div class="form-group">
                    ...
                    <select name="keterangan" class="form-control">
                        ...
                        <option value="Lupa input">Lupa input</option>
    ...
    document.querySelectorAll('.btn-batalkan').forEach(button => {
        ...
        button.addEventListener('click', function () {
            ...
            Swal.fire({
                title: 'Batalkan Data?',
                html: `
                    ⚠ Data ini akan dibatalkan dan stok akan dikurangi kembali.
                    <br><br>
                    Lanjutkan?
                `,
                icon: 'warning',
